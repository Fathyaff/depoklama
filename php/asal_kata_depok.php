    ...
    <div class="container-asal-kata-depok">
        <div class="row">
            <div class="col align-self-center">
                <div class="title-asal-kata-depok">
                    <h1>Asal Kata Depok</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col align-self-center">
                <div class="subtitle-asal-kata-depok">
                    ...
                    <p>Ayo dengarkan kisah Para Penutur!</p>
                </div>
            </div>
        </div>
        ...
        <!-- The Modal -->
        <div id="modalPeta" class="modal-asal-kata-depok">
            <!-- Modal content -->
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        <div class="row">
                            ...
                            Lucas van de Meur kepada Cornelis Chastelein dengan status kepemilikan nomor 872. 
                            Sebelumnya, tanah itu diberikan kepada Lucas van de Meur pada tanggal 15 Oktober 1695. 
                            Meskipun demikian, Mas Bondan menyatakan bahwa memang belum ada dokumen sejarah yang secara khusus 
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4">
                                ...
                                <div style="position:relative" id="toggle-peta-bondan" class="play-peta-bondan"></div>
                                <div style="position:absolute; left:0; bottom:0; float:right;margin-left: 45%;margin-bottom: -3%;">
                                    <p>Mas Bondan</p>
                                </div>
                            </div>
                            <div class="col-6 col-md-4">
                                ...
                                <div style="position:relative" id="toggle-peta-titi" class="play-peta-titi"></div>
                                <div style="position:absolute; left:0; bottom:0;float:left;margin-left:23%;margin-bottom:-3%">
                                    <p>Bu Titi</p>
                                </div>
                            </div>
                    ...
                    <div class="col-4 col-md-4 portfolio-hover">
                        <img id="petaimg" src="img/asets/asal_kata_depok/gambar_peta.png" alt="" width="90%" class=" img-responsive"/>
        ...
        <!-- The Modal -->
        <div id="modalPadepokan" class="modal-asal-kata-depok">
            <!-- Modal content -->
            <div class="modal-content">
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        <div class="row">
                            <p class="modal-desc-content">Nama Depok nyatanya tak hanya ditemukan sebagai nama wilayah di bagian selatan Batavia.
                                ...
                                kerajaan-kerajaan kuno di Nusantara. Namun demikian, belum ada bukti arkeologis yang dapat memperkuat dugaan ini. 
                                Bagaimana menurutmu?
                            </p>
                        </div>
                        <div class="row">
                            <div class="col-6 col-md-4">
                                ...
                                <div style="position:relative" id="toggle-padepokan-titi" class="play-padepokan-titi"></div>
                                <div style="position:absolute; left:0; bottom:0; float:right;margin-left: 56%;margin-bottom: -3%;">
                                    <p>Bu Titi</p>
                                </div>
                            </div>
                            <div class="col-6 col-md-4">
                                ...
                                <div style="position:relative" id="toggle-padepokan-lili" class="play-padepokan-lili"></div>
                    ...
                    <div class="col-4 col-md-4 portfolio-hover">
                        <img src="img/asets/asal_kata_depok/gambar_padepokan.png" alt="" width="90%" class=" img-responsive"/>
                        <div class="portfolio-hover-content" style="position:absolute; top:0">
                            <h2>Tahukah kamu?</h2>
         ...
         <!-- The Modal -->
         <div id="modalAkronim" class="modal-asal-kata-depok">
            <!-- Modal content -->
            <div class="modal-content">
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        <div class="row">
                            ...
                            Tentu saja organisasi yang dimaksud merujuk pada komunitas kristen yang dibentuk di wilayah Depok pada 
                            masa Cornelis Chastelein. Namun demikian, istilah tersebut bukan merupakan akronim Depok yang sebenarnya. 
                            Menurut Para Penutur, istilah itu dibentuk oleh komunitas orang-orang Depok yang hijrah ke Belanda setelah 
                            peristiwa Gedoran Depok. Istilah lain yang juga dibuat dengan akronim Depok yaitu “Daerah Pemukiman Orang Kota” 
                        ...
                        <div class="row">
                            <div class="col-6 col-md-3">
                                ...
                                <div style="position:relative" id="toggle-akronim-yano" class="play-akronim-yano"></div>
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <div style="position:relative" id="toggle-akronim-lili" class="play-akronim-lili"></div>
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <div style="position:relative" id="toggle-akronim-ferdy" class="play-akronim-ferdy"></div>
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <div style="position:relative" id="toggle-akronim-boy" class="play-akronim-boy"></div>
                    ...
                    <div class="col-4 col-md-4 portfolio-hover">
                        <img id="deEersteimg" src="img/asets/asal_kata_depok/DeEerste.png" alt="" width="90%" class=" img-responsive"/>
                        <div class="portfolio-hover-content" style="position:absolute; top:0">
        ...
        <script src="js/asal_kata_depok.js"></script>
