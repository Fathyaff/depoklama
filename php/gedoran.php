<!-- What We Do -->
<section id="gedoran" class="default-section">
    <div class="container-gedoran">
        <div class="row">
            <div class="col align-self-center">
                <div class="title-gedoran">
                    <h1>Gedoran Depok</h1>
                </div>
            </div>
        </div>
        ...
        <!-- The Modal -->
        <div id="modalProklamasi" class="modal-gedoran">
            <!-- Modal content -->
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        <div class="row">
                            ...
                            Mereka juga lebih suka mendengar saluran radio milik Belanda, karena ketidakmampuan mereka dalam berbahasa Indonesia. 
                            Saat berita kemerdekaan dikumandangkan, tentu saja saluran radio Belanda tidak menyiarkan berita tersebut. 
                            Hal ini menyebabkan tidak adanya bendera merah-putih yang dikibarkan di Depok Lama dalam rangka perayaan kemerdekaan kala itu. 
                            Spekulasi mengenai kaum Depok yang merupakan antek-antek Belanda pun muncul. 
        ...
        <!-- The Modal -->
        <div id="modalAlur" class="modal-gedoran">
            <!-- Modal content -->
            <div class="modal-content">
         ...
         <!-- The Modal -->
         <div id="modalPelaku" class="modal-gedoran">
            <!-- Modal content -->
            <div class="modal-content">
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        ...
                        <h2 class='modal-desc-title'>Siapakah Pelakunya</h2>
                            ...
                            Hal ini dikarenakan adanya kesenjangan sosial yang terjadi di Depok. 
                            Fasilitas kehidupan kaum Depok yang jauh lebih baik jika dibandingkan 
                            dengan warga di sekitarnya memang mungkin sekali menimbulkan rasa kecemburuan. 
                            Bahasa Belanda yang mereka kuasai dengan baik membuat mereka dapat dengan 
                            mudah bekerja di instansi-instansi pemerintahan pada masa kolonial Belanda. 
                            Hal ini semakin memperkuat adanya spekulasi bahwa kaum Depok adalah antek-antek Belanda. 
         ...
         <!-- The Modal -->
         <div id="modalBangunan" class="modal-gedoran">
            <!-- Modal content -->
            <div class="modal-content">
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        ...
                        <h2 class='modal-desc-title'>Bangunan Penting</h2>
                            ...
                            Gedung yang dimaksud adalah gedung bergaya arsitektur Belanda, yang memiliki monumen tugu Chastelein di depannya. 
        ...
        <script src="js/gedoran.js"></script>
