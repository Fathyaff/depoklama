<!-- What We Do -->
<section id="kdmc" class="default-section bg-white" style="
        background-image: url(img/asets/bg-kdmc.png); background-position: center; background-size: cover;
    ">
    <div class="container-kdmc">
        <div class="row">
            <div class="col align-self-center">
                <div class="title-kdmc">
                    <h1>Kehidupan Depok Masa Chastelein</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col align-self-center">
                <div class="subtitle-kdmc">
        ...
        <!-- The Modal -->
        <div id="modalVisi" class="modal-kdmc">
            <!-- Modal content -->
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        <div class="row">
                            ...
                            nusantara yang menganut agama kristen, pandai berbahasa Belanda dan mandiri dalam pengelolaan wilayahnya.
                             ...
                             uang tanpa mensejahterakan masyarakat Indonesia. 
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                                <audio id="audioVisiSuzana">
                                        <source src="audio/kdmc/Audio-Visi-Bu-Suzana-29.39.mp3" type="audio/mpeg">
                                </audio>
                                <div style="position:relative" id="toggle-visi-suzana" class="play-suzana"></div>
                                <div style="position:absolute; left:0; bottom:0; float:right;margin-left: 21%;margin-bottom: -3%;">
                                    <p>Ibu Suzana</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-4 col-md-4 portfolio-hover">
                        ...
                        <div class="portfolio-hover-content" style="position:absolute; top:0">
                            ...
                            Eduard Douwes Dekker dan <br>Ernest Douwes Dekker.<br> Sumber: http://core3.oomph.co.id</p>
                        </div>
        ...
        <!-- The Modal -->
        <div id="modalBudak" class="modal-kdmc">
            <!-- Modal content -->
            <div class="modal-content">
                    ...
                    <div class="col-8 col-md-8">
                        <div class="row">
                            <p class="modal-desc-content">“Praktek perbudakan di nusantara berbeda dengan perbudakan di Eropa!” Tandas Mas Bondan.
                             ...
                             Kisah lain dari Ibu Suzana mengatakan bahwa sebelum budak-budak tersebut dibeli oleh Chastelein, mereka adalah 
                             orang-orang yang ditangkap karena melawan Portugis (Ibu Suzana). 
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <div style="position:absolute; left:0; bottom:0; float:right;margin-left: 19%;margin-bottom: -3%;">
                                    <p>Ibu Suzana</p>
                                </div>
                            </div>
                        </div>
         ...
         <!-- The Modal -->
         <div id="modalPerkebunan" class="modal-kdmc">
            <!-- Modal content -->
            <div class="modal-content">
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        <div class="row">
                            ...
                            Meneer Lilie mengatakan bahwa produk-produk yang dihasilkan di Depok dilakukan untuk memasok sumber pangan ke 
                            Batavia serta memenuhi kebutuhan sehari-hari para budak. Sehingga para budak tersebut tidak perlu untuk mengimpor 
                            bahan pokok ke pemukiman para budak. 
                    ...
                    <div class="col-4 col-md-4 portfolio-hover">
                        ...
                        <div class="portfolio-hover-content" style="position:absolute; top:0">
                            ...
                            Ia dengan tegas melarang masyarakat Depok untuk menebangan pohon secara berlebihan, 
                            masyarakat hanya boleh menebang dan memanfaatkan kayu tersebut untuk peralatan dan kebutuhan sehari-hari mereka. 
                            Peraturan tersebut dibuat oleh Chastelein demi menjaga keseimbangan alam di Depok. 
                            ...
                            Cagar Alam Depok. Sumber gambar: http://jakarta.panduanwisata.id</p>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <!-- The Modal -->
         <div id="modalAturan" class="modal-kdmc">
            <!-- Modal content -->
            <div class="modal-content">
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8">
                        <div class="row">
                            ...
                            bahasa Belanda. Chastelein mengajarkan budaknya melalui media Alkitab berbahasa Belanda agar 
                            mereka dapat memahami pendidikan yang diberikan dan sekaligus juga dapat mengimani isi dari 
                            Alkitab tersebut. Selain itu, mereka juga harus menikah dengan sesama budak. 
