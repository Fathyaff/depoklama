    ...
    <div class="container-voting-nica-tkr">
        ...
        <div class="row nica-tkr-row">
            ...
            <div class="col-6 col-md-4">
                <img id="voting-button-nica" class="voting-button-nica-tkr" src="img/asets/voting/circle.png" onmouseover="onHoverNica();" onmouseout="offHoverNica();"/>
                <h4 class="text-voting-button"> NICA </h4>
            </div>
            <div class="col-6 col-md-4">
                <img id="voting-button-tkr" class="voting-button-nica-tkr" src="img/asets/voting/circle.png" onmouseover="onHoverTkr();" onmouseout="offHoverTkr();"/>
