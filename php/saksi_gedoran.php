<!-- What We Do -->
<section id="saksi-gedoran" class="default-section">
    <div class="container-saksi-gedoran">
        <div class="row">
            <div class="col align-self-center">
                <div class="title-saksi-gedoran">
                    <h1>Saksi Peristiwa Gedoran Depok</h1>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <!-- The Modal -->
        <div id="modalSaksiSuzana" class="modal-saksi-gedoran">
            <!-- Modal content -->
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8 col-xs-8">
                        ...
                        <h2 class='modal-desc-title'>Ibu Suzana</h2>
                            ...
                            merupakan salah satu korban Gedoran Depok. Kala itu, ia bersama kaum Depok lainnya 
                            ditangkap dan dibawa secara paksa ke Paledang, Bogor. 
        ...
        <!-- The Modal -->
        <div id="modalSaksiGovert" class="modal-saksi-gedoran">
            <!-- Modal content -->
            <div class="modal-content">
                ...
                <div class="row row-top">
                    <div class="col-8 col-md-8 col-xs-8">
                        ...
                        <h2 class='modal-desc-title'>Opa Govert</h2>
                            ...
                            Ia berusia 5 tahun ketika peristiwa Gedoran terjadi. Ia bersama ibu dan kakak-kakaknya 
                            ditahan di kantor pemerintahan. Pada saat itu, ia menceritakan bahwa ia akan dibakar bersama warga depok lainnya. 
        ...
        <script src="js/saksi_gedoran.js"></script>
